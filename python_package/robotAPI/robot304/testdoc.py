...
from robot304.conf import RobotSettings
from robot304.htmldata import HtmlFileWriter, ModelWriter, JsonWriter, TESTDOC
from robot304.parsing import disable_curdir_processing
from robot304.running import TestSuiteBuilder
from robot304.utils import (abspath, Application, file_writer, format_time,
...
def testdoc_cli(arguments):
    ...
    Example::
        ...
        from robot304.testdoc import testdoc_cli
...
def testdoc(*arguments, **options):
    ...
    Example::
        ...
        from robot304.testdoc import testdoc
